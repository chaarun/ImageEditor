...
class PhotoProviderActivity : AppCompatActivity() {
    ...
    companion object {
        private val TAG: String =
            PhotoProviderActivity::class.java.getSimpleName()
        ...
        fun showPhotoProviderOptions(
            context: Context,
            listener: PhotoOptionListener
        ) {
            // setup the alert builder
            val builder = AlertDialog.Builder(context)
            builder.setTitle(context.getString(R.string.lbl_read_photos))

            // add a list
            val readData = arrayOf(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_photo_provider)
        val intent = intent
        if (intent == null) {
            Toast.makeText(
                applicationContext,
    ...
    private fun cropImage(sourceUri: Uri?) {
        ...
        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.colorPrimaryLight))
